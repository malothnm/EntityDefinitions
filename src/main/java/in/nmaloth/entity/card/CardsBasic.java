...
import in.nmaloth.entity.product.*;
...
public class CardsBasic  {
    ...
    private Map<TransactionType, InternationalApplied> blockTransactionType;
    private IncludeExclude includeExcludeBlockTerminal;
    private Map<TerminalType,InternationalApplied> blockTerminalType;
    private IncludeExclude includeExcludeBlockLimitType;
    private Map<LimitType,InternationalApplied> blockingLimitType;
    private IncludeExclude includeExcludeBlockPurchaseType;
    private Map<PurchaseTypes,InternationalApplied> blockPurchaseTypes;
    private Boolean blockCashBack;
    private Boolean blockInstallments;
    private IncludeExclude includeExcludeBlockEntryMode;
    private Map<EntryMode,InternationalApplied> blockEntryMode;
